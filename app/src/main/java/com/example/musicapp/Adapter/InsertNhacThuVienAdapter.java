...
public class InsertNhacThuVienAdapter extends RecyclerView.Adapter<InsertNhacThuVienAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_tim_kiem_nhac_thuvien, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imginsertnhac.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InsertDataBaiHatThuVien(idthuvien, baiHat.getIdBaiHat());
                UpdateHinhThuVien(idthuvien, mangbaihat.get(position).getHinhBaiHat());
            }
        });

    }
    public void InsertDataBaiHatThuVien(int idtv, int idbh) {
        Dataservice dataservice = APIService.getService();
        Call<ResponseModel> callback = dataservice.insertnhacthuvien(idtv, idbh);
